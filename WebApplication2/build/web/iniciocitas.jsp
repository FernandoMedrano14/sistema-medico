<%-- 
    Document   : iniciocitas
    Created on : 09-13-2018, 09:43:49 AM
...
<html>
    ...
    <body ${mensaje}>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-info " aria-labelledby="navbarDropdown">
                            <%--
                                ...
                                <html:hidden property="nombrepagina" value="denegarcita"/>
                                <html:hidden property="accesoagregar" value="guardadoCita"/>
                                <html:submit property="action" value="Agregar Cita" styleClass="dropdown-item bg-info text-white"/>
                                </html:form>
                            --%>
        ...
        <br>
    <center><h2>¡BIENVENIDOS A CITAS!</center></h2>
<br>
...
<div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <img src="cit1.jpg" alt="Los Angeles" width="1100" height="500">
        </div>
        <div class="carousel-item">
            <img src="cit2.jpg" alt="Chicago" width="1100" height="500">
        </div>
        <div class="carousel-item">
            <img src="cit3.png" alt="New York" width="1100" height="500">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <center><h1>	
                    ...
                    Servicio orientado a agendar citas para usuarios que necesiten atención medica.
