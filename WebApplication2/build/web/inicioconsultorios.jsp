<%-- 
    Document   : inicioconsultorios
    Created on : 09-07-2018, 01:23:49 PM
         ...
         <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <p>  </p>
                    <li class="nav-item">
                        <a class="btn btn-outline-info" href="mantenimientoConsultorios.jsp">Agregar Consultorio</a>
                    </li>
                    <p>  </p>
                    <html:form action = "/MantenimientoConsultorios">
                        <html:submit styleClass="btn btn-outline-info" property="action" value="Consultar_Consultorios"/>
                    </html:form>
                </ul>
...
<div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <img src="col1.jpg" alt="Los Angeles" width="1100" height="500">
        </div>
        <div class="carousel-item">
            <img src="col2.jpg" alt="Chicago" width="1100" height="500">
        </div>
        <div class="carousel-item">
            <img src="col3.jpg" alt="New York" width="1100" height="500">
        </div>
    </div>
...
<div class="container">
    <div class="row">
        <div class="col-12">
            ...
            <center><h1>	
                    Nuestros consultorios estan conformados por especialistas en las diferencias áreas de la medicina, para satisfacer las necesidades de salud de cada paciente
