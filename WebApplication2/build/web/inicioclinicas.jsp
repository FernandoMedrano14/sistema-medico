<%-- 
    Document   : inicioclinicas
    Created on : 09-13-2018, 09:43:09 AM
...
<html>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <html:form action = "/MantenimientoClinicas">
                        <html:submit styleClass="btn btn-outline-info" property="action" value="Agregar Clinica"/>
        ...
        <br>
    <center><h2>¡BIENVENIDOS A CLINICAS!</center></h2>
<br>
...
<div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <img src="clini1.jpg" alt="Los Angeles" width="1100" height="500">
        </div>
        <div class="carousel-item">
            <img src="clini2.jpg" alt="Chicago" width="1100" height="500">
        </div>
        <div class="carousel-item">
            <img src="clini3.jpg" alt="New York" width="1100" height="500">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <center><h1>	
                    ...
                    En Nuestras Clínicas te ofrecemos servicios profesionales médicos de consulta externa.
