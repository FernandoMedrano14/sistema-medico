<%-- 
    Document   : iniciomedicos
    Created on : 09-13-2018, 09:42:14 AM
...
<html>
    ...
    <body>
        ...
        <br>
    <center><h2>¡BIENVENIDOS A MEDICOS!</center></h2>
<br>
...
<div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <img src="medico1.png" alt="Los Angeles" width="1100" height="500">
        </div>
        <div class="carousel-item">
            <img src="medico2.jpg" alt="Chicago" width="1100" height="500">
        </div>
        <div class="carousel-item">
            <img src="medico3.png" alt="New York" width="1100" height="500">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <center><h1>	
                    ...
                    Contamos con un equipo altamente capacitado y talentoso de médicos y profesionales con diferentes grados y áreas de enfoque
