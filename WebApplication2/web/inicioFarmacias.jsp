                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-info " aria-labelledby="navbarDropdown">
                            <html:form action="/AgregarUsuario" styleClass="form-inline my-2 my-lg-0">
                                <html:hidden property="nombrepagina" value="denegarfarmacias"/>
                                <html:hidden property="accesoagregar" value="guardadoFarmacia"/>
                                <html:submit property="action" value="Agregar Farmacia" styleClass="dropdown-item bg-info text-white"/>
                            </html:form>
