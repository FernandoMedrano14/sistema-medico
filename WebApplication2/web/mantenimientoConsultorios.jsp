...
<html>
    ...
    <body>
        ...
        <html:form action="/MantenimientoConsultorios">
            ...
            <br>
            <br>
            <h4 align="center">Formulario de ingreso para nueva Consultorio</h4>
            <h4 align="center">Ingrese la Informacion del consultorio</h4>
            <br>
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <table class="table table-striped">
                            ...
                            <td><html:text property="numero" size="30" maxlength="100"></html:text></td>
                            <td><html:text property="area" size="30" maxlength="100"></html:text></td>
                            <td><html:submit styleClass="btn btn-info" property="action" value="Agregar"/></td>
                            <td><html:submit styleClass="btn btn-outline-info" property="action" value="Consultar_Consultorios"/></td>
                            </tbody>
                        </table>
