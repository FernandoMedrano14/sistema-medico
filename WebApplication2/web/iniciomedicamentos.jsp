...
<html>
    <head>
        ...
        <title>Inicio Medicamentos</title>
    </head>
    <body>
        ...
        <br>
    <center><h2>¡BIENVENIDOS A MEDICAMENTOS!</center></h2>
<br>
...
<div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <img src="medica1.jpg" alt="Los Angeles" width="1100" height="500">
        </div>
        <div class="carousel-item">
            <img src="medica2.jpg" alt="Chicago" width="1100" height="500">
        </div>
        <div class="carousel-item">
            <img src="medica3.jpg" alt="New York" width="1100" height="500">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <center><h1>	
                   ...
                   Nuestros productos farmacéuticos enfocados a satisfacer algunas de las necesidades médicas más urgentes de nuestros pacientes.
