<%-- 
    Document   : modificarMedicos
    Created on : 09-25-2018, 03:53:03 PM
...
<html>
    ...
    <body>
        ...
        <br> 
        <br>
        <h4 align="center">Formulario de modificación de Medicos</h4>
        <h4 align="center">Ingrese los nuevos datos del Medico</h4>
        <br>
        <br>
        <br>
        <br>
                ...
                <div class="row">
                    <div class="col-12">
                        <table class="table table-stripped"> 
                            ...
                            <tbody>
                                <tr align="center">
                                    <td>
                                        ...
                                        <td>
                                        <html:text property="apellido" size="40" maxlength="" readonly="re"></html:text>
                                        </td>
                                        <td>
                            ...
                            <br>
                            <tr colspan="3">
                                <bean:write name="ActionFormMedicos" property="error" filter="false"/>
                            </tr>
                            </tbody>
                        </table>
                    </div>
