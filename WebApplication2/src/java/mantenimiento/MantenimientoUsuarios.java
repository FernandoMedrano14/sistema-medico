...
//        System.out.println(u.getNombre());
    ...
    public int consultarId(Integer idUsuario) {
...
//             session.getTransaction();
    ...
    public Usuarios consultaId(Integer idUsuario) {
        Usuarios con = null;
        String mensaje = "";
        System.out.println("Id en mantenimiento" + idUsuario);
        SessionFactory factory = HibernateUtil.getSessionFactory();
        Session session = factory.openSession();

        try {
            session.beginTransaction();
            con = (Usuarios) session.get(Usuarios.class, idUsuario);
            session.getTransaction().commit();
            mensaje = "Encontrado con exito";
        } catch (Exception e) {
            if (session.getTransaction().isActive());
            session.getTransaction().rollback();
            mensaje = "error al buscar por id";
            con = null;
        }
        return con;
    }
